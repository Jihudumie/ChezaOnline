...
HOME_TEXT = "👋🏻 **Habari yako [{}](tg://user?id={})**,\n\nMimi ni **Radio Player Bot** \nI Can Play Radio/Stream Music In Channels & Groups 24x7 Nonstop. Made with ❤️ By @Twuwbaa!"
HELP = """🏷️ **Need Help?** 🤔
...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton('CHANNEL', url='https://t.me/Mawaidha1'),
        InlineKeyboardButton('SUPPORT', url='https://t.me/ViongoziBot'),
    ],
    [
